...
import 'package:tourism/Home/Cuisine/editCuisine.dart';
                                        ...
                                        children: [
                                          Positioned(
                                            ...
                                            child: Container(
                                              ...
                                              child: Image.network(streamSnapshot.data!.docs[index]['cuisineImage'].toString(),fit: BoxFit.cover,),
                                            ),
                                          ),
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        ElevatedButton(
                                                          onPressed: (){
                                                            Navigator.push(context, MaterialPageRoute(builder: (context)=>EditCuisine(
                                                              cuisineImage : streamSnapshot.data!.docs[index]['cuisineImage'].toString(),
                                                              cuisineName : streamSnapshot.data!.docs[index]['cuisineName'].toString(),
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(streamSnapshot.data!.docs[index]['cuisineName'].toString(),
            ...
            Padding(
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  ...
                  child: Text('Add Cuisine',style:TextStyle(fontSize: 15,fontWeight: FontWeight.w600,color: wc)),
