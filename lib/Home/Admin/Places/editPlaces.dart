...
class EditPlaces extends StatefulWidget {
  ...
  const EditPlaces({super.key, required this.placeImage,
    required this.placeName, required this.cityName, required this.price,
...
class _EditPlacesState extends State<EditPlaces> {
  ...
  void initState() {
    if(widget.Status == "Edit"){
      imagePhote = widget.placeImage;
      _controllerPlace.text = widget.placeName;
      ...
      if(widget.Status == "Add"){
        imagePhote = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSPT1ZD82oy9S3Kzlpr3cjw2oiTx43aP7QRiQ&usqp=CAU";
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text('Edit Places',style:TextStyle(fontSize: 20,fontWeight: FontWeight.w500,color: wc)),
      ),
            ...
            child: Column(
              children: [
                      ...
                      Container(
                        ...
                        child: Container(
                          ...
                          child: Image.network(
                            imagePhote == "Null"
                                ?
                            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSPT1ZD82oy9S3Kzlpr3cjw2oiTx43aP7QRiQ&usqp=CAU"
                                : imagePhote.toString(),
                            fit: BoxFit.cover,
                          ),
                ...
                Container(
                  ...
                  child: Text('Add Place Image',style:TextStyle(fontSize: 17,fontWeight: FontWeight.w500,color: gc)),
                ),
                SizedBox(
                ...
                Container(
                  ...
                  child: Text('Enter Place Name',style:TextStyle(fontSize: 18,fontWeight: FontWeight.w500,color: gc)),
                ),
  ...
  Widget AddButton(){
    ...
    return
      Container(
        ...
        child: ElevatedButton(
          onPressed: (){
            if(imagePhote ==  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSPT1ZD82oy9S3Kzlpr3cjw2oiTx43aP7QRiQ&usqp=CAU"){
            ...
            FirebaseFirestore.instance
                ...
                .doc()
                .set({
              "placeImage": imagePhote.toString().trim(),

              "placeName": _controllerPlace.text.trim(),
