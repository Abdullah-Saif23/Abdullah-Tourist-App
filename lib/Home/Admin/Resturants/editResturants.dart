...
class EditResturants extends StatefulWidget {
  ...
  final String docId;
  final String Status;
  const EditResturants({super.key, required this.resturantImage,
    required this.resturantName, required this.cityName, required this.price,
    required this.description, required this.docId, required this.Status});

  @override
  State<EditResturants> createState() => _EditResturantsState();
}

class _EditResturantsState extends State<EditResturants> {
  ...
  void initState() {
    if(widget.Status == "Edit"){
      imagePhote = widget.resturantImage;
      _controllerPlace.text = widget.resturantName;
      ...
      if(widget.Status == "Add"){
        imagePhote = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQW7ej70Xb2RvTBlv1h4mKg7KWgcDHW9_-uIw&usqp=CAU";
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text('Edit Resturants',style:TextStyle(fontSize: 20,fontWeight: FontWeight.w500,color: wc)),
      ),
            ...
            child: Column(
              children: [
                      ...
                      Container(
                        ...
                        child: Container(
                          ...
                          child: Image.network(
                            imagePhote == "Null"
                                ?
                            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQW7ej70Xb2RvTBlv1h4mKg7KWgcDHW9_-uIw&usqp=CAU"
                                : imagePhote.toString(),
                            fit: BoxFit.cover,
                          ),
                ...
                Container(
                  ...
                  child: Text('Add Resturant Image',style:TextStyle(fontSize: 17,fontWeight: FontWeight.w500,color: gc)),
                ),
                SizedBox(
                ...
                Container(
                  ...
                  child: Text('Enter Resturant Name',style:TextStyle(fontSize: 18,fontWeight: FontWeight.w500,color: gc)),
                ),
  ...
  Widget AddButton(){
    ...
    return
      Container(
        ...
        child: ElevatedButton(
          onPressed: (){
            if(imagePhote ==  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQW7ej70Xb2RvTBlv1h4mKg7KWgcDHW9_-uIw&usqp=CAU"){
              Fluttertoast.showToast(
                  msg:
                  "Please Add Resturant Image",
              ...
              try {
                ...
                FirebaseFirestore.instance
                    ...
                    .doc()
                    .set({
                  "resturantImage": imagePhote.toString().trim(),

                  "resturantName": _controllerPlace.text.trim(),
